...
class BookInstance(models.Model):
    ...
    #borrower = models.OneToOneField('User', on_delete=models.RESTRICT, null=True)
...
class Author(models.Model):
    ...
    #books = models.ForeignKey(Book, on_delete=models.RESTRICT)
